...
export function LoginForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    setIsSubmitting(false); // Only set to false if login fails, otherwise redirected
  }
  ...
  return (
    <Card className="w-full max-w-sm bg-card/80 backdrop-blur-sm border-white/20 shadow-2xl shadow-primary/20">
      <CardHeader className="text-center">
        ...
        <CardDescription className="text-base font-medium text-primary-foreground/80">Enter your credentials to access your account.</CardDescription>
      </CardHeader>
      <CardContent>
