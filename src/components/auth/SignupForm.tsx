    ...
    <Card className="w-full max-w-sm bg-[#111111] border-neutral-800 shadow-2xl shadow-primary/30">
      <CardHeader className="text-center">
        <div className="flex justify-center items-center mb-4 gap-3">
            ...
            <h1 className="text-2xl font-headline text-primary-foreground">TitanicX</h1>
        </div>
        <CardTitle className="text-3xl font-headline font-bold text-primary-foreground">Create an Account</CardTitle>
        <CardDescription className="text-base font-medium text-muted-foreground">Join our community to share and receive disaster updates.</CardDescription>
      </CardHeader>
      <CardContent>
         <Button variant="outline" className="w-full bg-transparent text-primary-foreground border-neutral-700 hover:bg-neutral-800 hover:text-primary-foreground mb-6" onClick={handleGoogleSignIn}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input className="bg-[#1c1c1c] border-neutral-700 text-primary-foreground" placeholder="Your username" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input className="bg-[#1c1c1c] border-neutral-700 text-primary-foreground" placeholder="name@example.com" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input className="bg-[#1c1c1c] border-neutral-700 text-primary-foreground" type="password" placeholder="••••••••" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
